...
(function (Cardinality) {
    var Estimator = (function () {
         ...
         * @returns {}
         */
        Estimator.prototype.count = function () {
            ...
            if (e <= 5.0 * this.m)
                e = Cardinality.BiasCorrection.correctBias(e, this.bitsPerIndex);
            var h;
            if (v > 0)
         ...
         * @returns {}
         */
        Estimator.prototype.merge = function (other) {
            if (other.m !== this.m)
         ...
         * @returns {}
         */
        Estimator.prototype.addHashCode = function (hashCode) {
            if (this.directCount != null) {
        ...
        Estimator.getLookupCount = function (lookupObj) {
            var n = 0;
            for (var k in lookupObj)
                ++n;
            return n;
        };
        Estimator.longRShift = function (n, bits) {
            var res = [];
            if (bits < 32) {
         ...
         * @returns {}
         */
        Estimator.getSubAlgorithmSelectionThreshold = function (bits) {
            switch (bits) {
                case 4:
                    return 10;
                case 5:
         ...
         */
        Estimator.getAlphaM = function (m) {
            switch (m) {
                case 16:
                    return 0.673;
                case 32:
         ...
         */
        Estimator.getSigma = function (hash, bitsToCount) {
            var sigma = 1;
         ...
         * @returns {}
         */
        Estimator.prototype.switchToDenseRepresentation = function () {
            if (!this.isSparse)
                return;
        ...
        Estimator.prototype.toJson = function () {
            // compact form
            return {
                v: [this.bitsPerIndex, this.bitsForHll, this.m, this.alphaM, this.subAlgorithmSelectionThreshold, this.lookupDense, this.lookupSparse, this.sparseMaxElements, this.isSparse, this.directCount]
            };
        };
        // Max number of elements to hold in the direct representation
        Estimator.DirectCounterMaxElements = 100;
        return Estimator;
    })();
...
(function (Cardinality) {
    ...
    (function (BiasCorrection) {
        /// Various raw estimates used to find the index of the bias value.  rawEstimates[k - bitsIndexOffset] contains an array of raw estimates sampled from a k-bit estimator, <see cref="bitsIndexOffset" />
        var rawEstimates = new Array(15);
        /// Bias values, each corresponding to the <see cref="rawEstimates"/> with the same indexes.
        var biasData = new Array(15);
        /// Offset for lookup in the array. The values for a k-bit estimator will be at index k-bitsIndexOffset
        var bitsIndexOffset = 4;
        /**
         * Corrects the bias for the given valueToCorrect
         * @param arr - Cardinality estimate to correct
         * @param search - Number of bits in the estimator
         * @returns {number} - The bias-corrected estimate
         */
        function binarySearch(arr, search) {
            var max = arr.length - 1, min = 0, middle;
            while (max >= min) {
        ...
        /**
         * Gets the estimated bias for the given rawEstimates
         * @param rawEstimate - Estimated cardinality before bias correction
         * @param bits - Number of bits in the estimator
         * @returns {number} - The estimated bias for the given raw estimate. Subtract this value from the rawEstimates to obtain a corrected estimate
         */
        function getBias(rawEstimate, bits) {
            var index = binarySearch(rawEstimates[bits - bitsIndexOffset], rawEstimate);
            if (index >= 0) {
            ...
            index = ~index;
            if (index >= rawEstimates[bits - bitsIndexOffset].length) {
                // The raw estimate is larger than all the values in the array, use the bias of the largest element
                return biasData[bits - bitsIndexOffset][biasData[bits - bitsIndexOffset].length - 1];
            }
            if (index <= 0) {
                // The raw estimate is smaller than all the values in the array, use the bias of the smallest element
                return biasData[bits - bitsIndexOffset][0];
            }
            var nextLarger = rawEstimates[bits - bitsIndexOffset][index];
            var nextLargerBias = biasData[bits - bitsIndexOffset][index];
            var nextSmaller = rawEstimates[bits - bitsIndexOffset][index - 1];
            var nextSmallerBias = biasData[bits - bitsIndexOffset][index - 1];
            var fraction = (rawEstimate - nextSmaller) / (nextLarger - nextSmaller);
            var bias = nextSmallerBias + fraction * (nextLargerBias - nextSmallerBias);
            return bias;
        }
        /**
         * Gets the estimated bias for the given valueToCorrect
         * @param valueToCorrect - Estimated cardinality before bias correction
         * @param bits - Number of bits in the estimator
         * @returns {number}  - The estimated bias for the given raw estimate. Subtract this value from the rawEstimates to obtain a corrected estimate
         */
        function correctBias(valueToCorrect, bits) {
            var bias = getBias(valueToCorrect, bits);
            return Math.max(valueToCorrect - bias, 0);
        }
        BiasCorrection.correctBias = correctBias;
        /**
         * /// Fills the raw-estimate array, for later lookup
         * @returns {}
         */
        function fillRawEstimateArray() {
            // precision 4
            rawEstimates[4 - bitsIndexOffset] = [
                11,
                11.717,
                12.207,
                12.7896,
            ...
            // precision 5
            rawEstimates[5 - bitsIndexOffset] = [
                23,
                23.1194,
                23.8208,
                24.2318,
            ...
            // precision 6
            rawEstimates[6 - bitsIndexOffset] = [
                46,
                46.1902,
                47.271,
                47.8358,
            ...
            // precision 7
            rawEstimates[7 - bitsIndexOffset] = [
                92,
                93.4934,
                94.9758,
                96.4574,
            ...
            // precision 8
            rawEstimates[8 - bitsIndexOffset] = [
                184.2152,
                187.2454,
                190.2096,
                193.6652,
            ...
            // precision 9
            rawEstimates[9 - bitsIndexOffset] = [
                369,
                374.8294,
                381.2452,
                387.6698,
            ...
            // precision 10
            rawEstimates[10 - bitsIndexOffset] = [
                738.1256,
                750.4234,
                763.1064,
                775.4732,
            ...
            // precision 11
            rawEstimates[11 - bitsIndexOffset] = [
                1477,
                1501.6014,
                1526.5802,
                1551.7942,
            ...
            // precision 12
            rawEstimates[12 - bitsIndexOffset] = [
                2954,
                3003.4782,
                3053.3568,
                3104.3666,
            ...
            // precision 13
            rawEstimates[13 - bitsIndexOffset] = [
                5908.5052,
                6007.2672,
                6107.347,
                6208.5794,
            ...
            // precision 14
            rawEstimates[14 - bitsIndexOffset] = [
                11817.475,
                12015.0046,
                12215.3792,
                12417.7504,
            ...
            // precision 15
            rawEstimates[15 - bitsIndexOffset] = [
                23635.0036,
                24030.8034,
                24431.4744,
                24837.1524,
            ...
            // precision 16
            rawEstimates[16 - bitsIndexOffset] = [
                47271,
                48062.3584,
                48862.7074,
                49673.152,
            ...
            // precision 17
            rawEstimates[17 - bitsIndexOffset] = [
                94542,
                96125.811,
                97728.019,
                99348.558,
            ...
            // precision 18
            rawEstimates[18 - bitsIndexOffset] = [
                189084,
                192250.913,
                195456.774,
                198696.946,
        ...
        function fillBiasDataArray() {
            // Precision 4
            biasData[4 - bitsIndexOffset] = [
                10,
                9.717,
                9.207,
                8.7896,
        ...
        fillBiasDataArray();
    })(BiasCorrection = Cardinality.BiasCorrection || (Cardinality.BiasCorrection = {}));
})(Cardinality || (Cardinality = {}));
